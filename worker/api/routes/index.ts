...
import { setupVersionsRoutes } from './versionsRoutes';
import { setupFileRoutes } from './fileRoutes';
import { setupAiEditRoutes } from './aiEditRoutes';
...
export function setupRoutes(app: Hono<AppEnv>): void {
    ...
    // Version history and app forking routes
    setupVersionsRoutes(app);

    // File editor routes (direct file CRUD for code editor)
    setupFileRoutes(app);

    // AI inline code edit route
    setupAiEditRoutes(app);
}
