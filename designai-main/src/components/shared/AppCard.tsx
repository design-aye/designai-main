			...
			>
				...
				>
					...
					<div className="relative aspect-[16/9] rounded-lg overflow-hidden bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/20 dark:to-orange-900/20">
						...
						{/* Fork button - shown on hover for public apps */}
						{onFork && isPublicApp(app) && (
							<button
								onClick={(e) => {
									e.stopPropagation();
									e.preventDefault();
								...
								className="absolute top-2 left-2 opacity-0 group-hover:opacity-100 transition-all duration-200 flex items-center gap-1 px-2 py-1 rounded-md bg-bg-3/90 backdrop-blur-sm hover:bg-bg-3 text-text-tertiary hover:text-text-primary text-[11px] font-medium"
								title="Fork this app"
								aria-label="Fork app"
							>
